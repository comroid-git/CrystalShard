...
public class OldPagedEmbed {
    ...
    public final static ConcurrentHashMap<Long, ConcurrentLinkedQueue<OldPagedEmbed>> instances = new ConcurrentHashMap<>();
     ...
     */
    public OldPagedEmbed(MessageReciever messageable, Supplier<Embed.Builder> embedsupplier) {
     ...
     */
    public OldPagedEmbed addField(String title, String text) {
     ...
     */
    public OldPagedEmbed addField(String title, String text, boolean inline) {
