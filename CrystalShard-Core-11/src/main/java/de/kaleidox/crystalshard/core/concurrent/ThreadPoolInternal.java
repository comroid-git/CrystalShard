...
public class ThreadPoolInternal implements de.kaleidox.crystalshard.core.concurrent.ThreadPool {
    // Static Fields
    ...
    private final static Logger                                   logger               = new Logger(ThreadPoolInternal.class);
     ...
     */
    public ThreadPoolInternal(Discord discord) {
     ...
     */
    public ThreadPoolInternal(Discord discordObject, int maxSize, String name) {
    ...
    public class BotOwn implements Executor {
         ...
         */
        BotOwn(ThreadPoolInternal pool) {
            this.pool = pool;
        }
