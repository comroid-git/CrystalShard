...
public final class GatewayGuildBanAddPayload extends AbstractGatewayPayload {
    @RootBind
    ...
    public GatewayGuildBanAddPayload(GatewayPayloadWrapper gpw) {
        super(gpw);

        getGuild().banUser(getUser());
    }
}
