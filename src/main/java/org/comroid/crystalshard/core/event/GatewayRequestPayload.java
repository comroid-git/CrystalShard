...
public interface GatewayRequestPayload extends Event<DiscordBotEvent>, VarCarrier.Underlying<Object> {
    ...
    final class Basic extends Event.Support.Abstract<DiscordBotEvent> implements GatewayRequestPayload {
