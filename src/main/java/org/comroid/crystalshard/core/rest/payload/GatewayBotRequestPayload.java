...
public final class GatewayBotRequestPayload extends AbstractDiscordResponsePayload {
    ...
    public static final VarBind<String, DiscordBot, URI, URI> Uri
            = Root.createBind("url")
            ...
            .setRequired()
            .build();
    public static final VarBind<Integer, DiscordBot, Integer, Integer> ShardCount
            ...
            .setRequired()
            .build();
    public static final VarBind<UniObjectNode, DiscordBot, SessionStartLimit, SessionStartLimit> SessionLimit
