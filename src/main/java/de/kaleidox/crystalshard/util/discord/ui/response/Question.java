 ...
 *
 * @param <ResultType> The Type that is asked for. You will later get a
 *                     CompletableFuture of this type, that will contain the response object.
 */
...
public class Question<ResultType> extends ResponseElement<ResultType> {
                    ...
                    .thenAcceptAsync(message -> {
                        ...
                        message.attachReactionAddListener(event -> {
                            ...
                            if (!user.isYourself() && userCanRespond.test(user)) {
                                Optional<Option> any = optionsOrdered
                                        .stream()
    ...
    public class Option {
        ...
        /**
         * Builds a new Option.
         * Can be used in {@link Question#addOption(Question.Option)}.
         *
