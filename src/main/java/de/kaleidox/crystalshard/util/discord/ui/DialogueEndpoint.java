...
/**
 * This class represents an Endpoint in a dialogue. When an instance of this class is used as a new branch withing an
 * {@link de.kaleidox.crystalshard.util.discord.ui.DialogueBranch.Option}, that option will lead to the end of the
 * branch. The instance requires a Consumer that will be able to consume an ordered list of the responses within the
 * Dialogue.
 * <p>
