...
public class UserActivityInternal implements UserActivity {
    ...
    private final UserActivity.ActivityType type;
    ...
    public UserActivityInternal(JsonNode data) {
        ...
        this.type = UserActivity.ActivityType.getFromId(data.get("type").asInt(-1));
        this.streamUrl = UrlHelper.orNull(data.get("url").asText());
        this.timestamps = data.has("timestamps") ?
                new BiTimestamp(data.get("timestamps")) : null;
        ...
        this.party = data.has("party") ?
                new UserActivityInternal.Party(data.get("party")) : null;
        this.assets = data.has("assets") ?
                new UserActivityInternal.Assets(data.get("assets")) : null;
        this.secrets = data.has("secrets") ?
                new UserActivityInternal.Secrets(data.get("secrets")) : null;
