...
public class EmbedBuilderInternal implements Embed.Builder {
    ...
    public Embed.Builder setTitle(String title) {
        ...
        if (title.length() > Embed.Boundaries.TITLE_LENGTH) {
            throw new IllegalArgumentException("Title length must not exceed " +
                    Embed.Boundaries.TITLE_LENGTH + " Characters!");
        }
        this.title = title;
        return this;
    }
    ...
    public Embed.Builder setDescription(String description) {
        ...
        if (description.length() > Embed.Boundaries.DESCRIPTION_LENGTH) {
            throw new IllegalArgumentException("Description length must not exceed " +
                    Embed.Boundaries.DESCRIPTION_LENGTH + "Characters!");
        }
    ...
    public Embed.Builder setFooter(EmbedDraft.Footer footer) {
        ...
        if (footer.getText().length() > Embed.Boundaries.FOOTER_LENGTH) {
            throw new IllegalArgumentException("Footer text must not exceed " +
                    Embed.Boundaries.FOOTER_LENGTH + " characters!");
        }
        this.footer = footer;
        return this;
    }
    ...
    public Embed.Builder setAuthor(EmbedDraft.Author author) {
        ...
        if (author.getName().length() > Embed.Boundaries.AUTHOR_NAME_LENGTH) {
            throw new IllegalArgumentException("Author name must not exceed " +
                    Embed.Boundaries.AUTHOR_NAME_LENGTH + " characters!");
        }
        this.author = author;
        return this;
    }
    ...
    public Embed.Builder addField(EmbedDraft.Field field) {
        ...
        if (fields.size() >= Embed.Boundaries.FIELD_COUNT) {
            throw new IllegalArgumentException("Field amount must not exceed " +
                    Embed.Boundaries.FIELD_COUNT + "!");
        }
        ...
        if (field.getTitle().length() > Embed.Boundaries.FIELD_TITLE_LENGTH) {
            throw new IllegalArgumentException("Field title must not exceed " +
                    Embed.Boundaries.FIELD_TITLE_LENGTH + " characters!");
        }
        ...
        if (field.getText().length() > Embed.Boundaries.FIELD_TEXT_LENGTH) {
            throw new IllegalArgumentException("Field text must not exceed " +
                    Embed.Boundaries.FIELD_TEXT_LENGTH + " characters!");
        }
    ...
    @Override
    public Embed.Builder updateFields(Predicate<EmbedDraft.Field> predicate,
