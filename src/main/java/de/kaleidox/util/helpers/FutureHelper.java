...
// Static membe
    ...
    /**
     * Waits for the completion of all given {@link CompletableFuture}s. Returns a future that completes with a list of
     * values returned by the Futures. Runs in async by default.
     *
