...
public interface MessageSentEvent extends DiscordEvent, WrappedGuildEvent, ChannelEvent<TextChannel>, WrappedRoleEvent, WrappedUserEvent, WrappedWebhookEvent, MessageEvent {
}
