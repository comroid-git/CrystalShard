...
import static de.kaleidox.crystalshard.util.FileType.IMAGE.*;
...
public class ImageEndpoint {
    ...
    public enum Location {
        ...
        public ImageEndpoint createUri(String iconHash, Object... parameter) {
            ...
            if (parameterCount == params.length) {
                ...
                throw new IllegalArgumentException("Too " + (parameterCount > params.length ? "few" : "many") + " parameters!");
        }

        public FileContainer createForFile(File file) {
            return null; // todo
        }
    }
}
