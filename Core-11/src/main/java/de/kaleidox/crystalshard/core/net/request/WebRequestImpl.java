...
public class WebRequestImpl<T> implements WebRequest<T> {
    ...
    public WebRequestImpl(Discord discord) {
        this(null, discord, null, null, null);
    }
    
    public WebRequestImpl(Discord discord, Method method, Endpoint endpoint, JsonNode node) {
        this(null, discord, method, endpoint, node);
    }
    
    public WebRequestImpl(CompletableFutureExtended<T> future, Discord discord, Method method, Endpoint endpoint, JsonNode node) {
